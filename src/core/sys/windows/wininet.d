...
const TCHAR[]
    GOPHER_INFO_CATEGORY      = TEXT!"+INFO",
    GOPHER_ADMIN_CATEGORY     = TEXT!"+ADMIN",
    GOPHER_VIEWS_CATEGORY     = TEXT!"+VIEWS",
    GOPHER_ABSTRACT_CATEGORY  = TEXT!"+ABSTRACT",
    GOPHER_VERONICA_CATEGORY  = TEXT!"+VERONICA",
    GOPHER_ADMIN_ATTRIBUTE    = TEXT!"Admin",
    GOPHER_MOD_DATE_ATTRIBUTE = TEXT!"Mod-Date",
    GOPHER_TTL_ATTRIBUTE      = TEXT!"TTL",
    GOPHER_SCORE_ATTRIBUTE    = TEXT!"Score",
    GOPHER_RANGE_ATTRIBUTE    = TEXT!"Score-range",
    GOPHER_SITE_ATTRIBUTE     = TEXT!"Site",
    GOPHER_ORG_ATTRIBUTE      = TEXT!"Org",
    GOPHER_LOCATION_ATTRIBUTE = TEXT!"Loc",
    GOPHER_GEOG_ATTRIBUTE     = TEXT!"Geog",
    GOPHER_TIMEZONE_ATTRIBUTE = TEXT!"TZ",
    GOPHER_PROVIDER_ATTRIBUTE = TEXT!"Provider",
    GOPHER_VERSION_ATTRIBUTE  = TEXT!"Version",
    GOPHER_ABSTRACT_ATTRIBUTE = TEXT!"Abstract",
    GOPHER_VIEW_ATTRIBUTE     = TEXT!"View",
    GOPHER_TREEWALK_ATTRIBUTE = TEXT!"treewalk";
...
const TCHAR[] HTTP_VERSION = TEXT!"HTTP/1.0";
